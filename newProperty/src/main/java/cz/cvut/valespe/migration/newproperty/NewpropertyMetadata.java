 ...
 * @since 1.1.0
 */
public class NewpropertyMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {

    // Constants
    private static final String PROVIDES_TYPE_STRING = NewpropertyMetadata.class.getName();
    ...
    public NewpropertyMetadata(String identifier, JavaType aspectName, PhysicalTypeMetadata governorPhysicalTypeMetadata) {
