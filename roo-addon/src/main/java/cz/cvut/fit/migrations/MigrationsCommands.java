...
@Service
public class MigrationsCommands implements CommandMarker { // All command types must implement the CommandMarker interface
    
    /**
     * Get a reference to the MigrationsOperations from the underlying OSGi container
     */
    @Reference private MigrationsOperations operations;
     ...
     */
    @CliAvailabilityIndicator({ "migrations setup", "migrations add", "migrations all" })
     ...
     * @param type 
     */
    @CliCommand(value = "migrations add", help = "Some helpful description")
     ...
     * 
     */
    @CliCommand(value = "migrations all", help = "Some helpful description")
    public void all() {
     ...
     * 
     */
    @CliCommand(value = "migrations setup", help = "Setup Migrations addon")
    public void setup() {
        operations.setup();
    }
}