 ...
 * @since 1.1.0
 */
public class RemoveclassMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {

    // Constants
    private static final String PROVIDES_TYPE_STRING = RemoveclassMetadata.class.getName();
    ...
    public RemoveclassMetadata(String identifier, JavaType aspectName, PhysicalTypeMetadata governorPhysicalTypeMetadata) {
