...
@RunWith(Suite.class)
@Suite.SuiteClasses({ RunRooScriptTest.class, InitProjectTest.class, MigrationSetupTest.class, NewClassTest.class, NewPropertyTest.class, RemoveClassTest.class })
