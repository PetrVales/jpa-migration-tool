 ...
 * @since 1.1.0
 */
public class SetupMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {

    // Constants
    private static final String PROVIDES_TYPE_STRING = SetupMetadata.class.getName();
    ...
    public SetupMetadata(String identifier, JavaType aspectName, PhysicalTypeMetadata governorPhysicalTypeMetadata) {
