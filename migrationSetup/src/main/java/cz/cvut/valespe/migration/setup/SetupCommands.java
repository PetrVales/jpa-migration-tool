...
@Service
public class SetupCommands implements CommandMarker { // All command types must implement the CommandMarker interface
    
    /**
     * Get a reference to the SetupOperations from the underlying OSGi container
     */
    @Reference private SetupOperations operations;
     ...
     */
    @CliAvailabilityIndicator({ "setup setup", "setup add", "setup all" })
     ...
     * @param type 
     */
    @CliCommand(value = "setup add", help = "Some helpful description")
     ...
     * 
     */
    @CliCommand(value = "setup all", help = "Some helpful description")
    public void all() {
     ...
     * 
     */
    @CliCommand(value = "setup setup", help = "Setup Setup addon")
    public void setup() {
        operations.setup();
    }
}