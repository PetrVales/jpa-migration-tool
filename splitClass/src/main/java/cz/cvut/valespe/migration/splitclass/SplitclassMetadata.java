 ...
 * @since 1.1.0
 */
public class SplitclassMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {

    // Constants
    private static final String PROVIDES_TYPE_STRING = SplitclassMetadata.class.getName();
    ...
    public SplitclassMetadata(String identifier, JavaType aspectName, PhysicalTypeMetadata governorPhysicalTypeMetadata) {
