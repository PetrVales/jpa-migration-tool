...
public class MovePropertyOperationsTest {
    ...
    private static final String MIGRATION_FILE_CONTENT_AFTER =
            "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>\n" +
                    ...
                    "\n" +
                    "<changeSet>\n" +
                    "        <addColumn tableName=\"to-table\">\n" +
                    "            <column name=\"column-name\" type=\"column-type\"/>\n" +
                    "        </addColumn>\n" +
                    "        <dropColumn columnName=\"column-name\" tableName=\"from-table\"/>\n" +
                    "    </changeSet>\n" +
                    "</databaseChangeLog>\n";
    ...
    public void moveColumn() {
        ...
        movePropertyOperations.moveColumn(COLUMN_NAME, COLUMN_TYPE, FROM_TABLE, TO_TABLE);
